...
- **Public SDK surface area (what we export / what users call)**:
  - [__init__.py](__init__.py) (exports + façade)
...
- **Configuration (env vars + defaults)**:
  ...
  - [README.md](README.md) + [INSTALLATION.md](INSTALLATION.md) (setup guidance)
...
See: [INSTALLATION.md](INSTALLATION.md) and [CONTRIBUTING.md](CONTRIBUTING.md).
...
2. Add delegation (and docstring) in `TradeStationSDK` ([__init__.py](__init__.py)) if it’s part of the public façade.
